...
@property (nonatomic, strong) PSHutkoWKWebView *webView;
...
- (void)viewDidLoad {
    ...
    self.api = [PSHutkoApi apiWithMerchant:1700002 andHutkoView:self.webView];
}

- (void)addCustomLocalization {
    [PSHutkoApi setLocalization:[PSLocalization customLocalization:@"card:" aExpiry:@"expiry:" aMonth:@"month" aYear:@"year" aCvv:@"cvv"]];
...
- (void)setupWebView {
    self.webView = [[PSHutkoWKWebView alloc] initWithFrame:CGRectMake(0, 64, self.view.bounds.size.width, self.view.bounds.size.height - 66)];
